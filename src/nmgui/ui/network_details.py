...
from nmgui.ui.utils import UIUtils
from nmgui.ui.dialogs import PasswordDialog
...
class NetworkDetailsWidget(Gtk.Box):
    ...
    def _create_content(self):
        ...
        self.content_box = Gtk.Box(orientation=Gtk.Orientation.VERTICAL, spacing=12)  # Reduced from 16 to 12
        ...
        advanced_header.set_margin_top(8)  # Reduced from 10 to 8
    ...
    def _create_action_buttons(self):
        ...
        if not self.network.is_connected:
            ...
            self.join_button.set_hexpand(True)
        ...
        if self.network.is_connected:
            ...
            self.disconnect_button.set_hexpand(True)
        ...
        if is_known:
            ...
            self.forget_button.set_hexpand(True)
